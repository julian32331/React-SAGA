...
class LocationPlace extends React.Component{
    componentDidMount() {
        document.title = "Kelowna";
    }

    componentWillMount() {
        const { locationData, fetchLocationData } = this.props;
        fetchLocationData(this.props.match.params.name);
    }
    render(){
                ...
                <div className="container">
                    <div className="row text-parent">
                        <div className="col">
                            ...
                            <div className="text">
                                <div className="text-head mb-3">{locationData && locationData.location && 'WELCOME TO C3 church ' + locationData.location.name}</div>
                                ...
                                <div className="secondColor pastorWrapper">
                                    <div className="float-left profile">
                                    {locationData && locationData.location && <img src={locationData.location.pastor_photo_url} alt="" className="h125"/>}
                                    </div>
                                    <div className="profile-kelowna">
                                        ...
                                        <br/>
                                        <span>{locationData && locationData.location && 'C3 church ' + locationData.location.name}</span>
                    ...
                    <div className="btn">
                    { locationData && locationData.location && ('JOIN US EVERY ' + locationData.location.day + ' ' + locationData.location.times) }
                    </div>
...
const mapStateToProps = (state, ownProps) => ({
    ...
    status: state.locationData.status
});
...
export default connect(mapStateToProps, mapDispatchToProps)(LocationPlace)