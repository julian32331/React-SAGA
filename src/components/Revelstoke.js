...
import { fetchRevelstokeLocation } from '../actions/locationAction';
...
class Revelstoke extends React.Component{
    componentDidMount() {
        document.title = "Revelstoke";
    }

    componentWillMount() {
        const { locationData, fetchRevelstokeLocation } = this.props;
        if(!locationData) {
            fetchRevelstokeLocation();
        }
    }
    render(){
                            ...
                            <div className="text">
                                ...
                                <div className="secondColor">
                                    ...
                                    <div className="profile-revelstoke">
                                        ...
                                        <br/>
                                        <span>C3 Church Revelstoke</span>
...
const mapStateToProps = (state, ownProps) => ({
    locationData: state.locationData.revelstoke
});
...
export default connect(mapStateToProps, mapDispatchToProps)(Revelstoke)